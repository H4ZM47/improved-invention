...
readonly FORMULA_OUTPUT="${FORMULA_OUTPUT:-${METADATA_OUTPUT_DIR}/homebrew-tap/Formula/grind.rb}"
...
cp "${FORMULA_OUTPUT}" "${HOMEBREW_TAP_DIR}/Formula/grind.rb"

printf '%s\n' "${HOMEBREW_TAP_DIR}/Formula/grind.rb"
