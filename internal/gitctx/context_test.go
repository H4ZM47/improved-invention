...
func TestDetectReturnsRepoAndRemoteContext(t *testing.T) {
	...
	if got, want := current.RemoteURL, "https://github.com/H4ZM47/grind.git"; got != want {
		t.Fatalf("RemoteURL = %q, want %q", got, want)
	}
	if got, want := current.RepoTarget(), "https://github.com/H4ZM47/grind.git"; got != want {
...
func initGitRepo(t *testing.T) string {
	...
	for _, args := range [][]string{
		...
		{"git", "-C", repoDir, "remote", "add", "origin", "https://github.com/H4ZM47/grind.git"},
	} {
